  ...
  \Q Now make the following changes to your program, testing those
    ...
    \begin{enumerate}
      \item Add 1000 to the list of test values.
        \begin{answer}[1in]
          Change line 16 to \python{vals <- c( -1, 0, 1, 2, 10, 100, 1000)}
        \end{answer}
      \item Set {\tt numerator = 4.0} on line 4 and
        ...
        \begin{answer}[1in]
          \begin{itemize}
            \itemsep 0pt
            \item Change line 4 to \python{4.0 -> numerator}
      ...
      \item Change the loop starting on line 6 so that it steps
        ...
        \begin{answer}[0.5in]
          \begin{itemize}
            \itemsep 0pt
            \item Change line 6 to \python{for ( i in seq(1, 2 * terms, 2))}
            \item Change line 8 to \python{denominator <- i}
            \item Change line 11 to \python{return(pi)}
          \end{itemize}
        \end{answer}
    \end{enumerate}