\model{Google Directions from KRH to Walmart}
  \begin{center}
    \fcolorbox{black}{orange!20}{
    \begin{minipage}{3.5in}
      \begin{enumerate}
        \item Head east towards SW 4th Street
        \item Travel 200 feet
        \item Turn left onto SW 4th Street
        \item Travel 344 feet
        \item Turn right onto S. College Avenue
        \item Travel 0.7 miles
        \item Turn left onto SE Lamperti Lane
        \item Travel 0.3 miles
        \item Turn right into Walmart Parking Lot
        \item Travel 0.1 miles
  ...
  \Q Give at least one assumption that is being made in the directions above.
    \begin{answer}[0.75in]
  ...
  \Q List at least two additional instructions that could be
    ...
    \begin{answer}[1in]
      \begin{itemize}
        \item Before a: Get into your car
        \item Before items c, e, g, i: Stop at the intersection until
  ...
  \Q Think about the process of brushing your teeth. Write down
    step-by-step instruc-\key\\[-2.5mm]cions (e.g. an algorithm) that
