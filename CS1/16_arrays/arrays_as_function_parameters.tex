\model{Arrays as Function Parameters} \\[-20pt]
  \begin{center}
...
\newpage
    ...
    \Q How is the 2D array defined on line 25 used in this program?  In particular, suppose the
...
---+---+---
   |   |              
    ...
    \Q What happens if you change the values of the constants on lines 5 and 6 from \cpp{3} to
      \cpp{4}?
      \begin{answer}[0.5in]
