...
int main() {
  ...
  \Q Determine if the functions prototyped in the model above have 1D, 2D, or no array parameters.
    \begin{enumerate}
      \itemsep 10pt
      \begin{multicols}{2}
        \item \cpp{void initBoard(...)}\hspace{0.5in}\ans[0.75in]{2D}
        \item \cpp{void printBoard(...)}\hspace{0.5in}\ans[0.75in]{2D}
...
---+---+---
  ...
  \Q What happens if you change the values of the constants on lines 1L and 2L from \cpp{3} to
    \cpp{4}?
    \begin{answer}[0.5in]
