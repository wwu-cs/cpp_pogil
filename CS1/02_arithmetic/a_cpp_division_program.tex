...
int main() {
  ...
  {\it\large Refer to Model 3 above as your group develops consensus answers to
    the questions below.}

  \quest{20 min}
    
  \Q This program can be found in {\tt activity02b.cpp}.  Run it several times with the
    following inputs and write down the resulting output.
    \begin{enumerate}
      \itemsep 10pt
