 \model{Assignment Operators} \\
  ...
  {\it\large Refer to Model 3 above as your team develops consensus answers
    ...
    \Q The code \cpp{x += 5;} is equivalent to which of the following lines of code?\par\vskip 10pt
      \hspace{20pt}
      \begin{oneparcheckboxes}
        \choice \cpp{x = 5;}
        \choice \cpp{x = y + 5;}
        \correctchoice \cpp{x = x + 5;}
        \choice \cpp{y = x + 5;}
    ...
    \Q An {\it assignment operator} provides a concise way of creating assignment statements when the variable on the
      ...
      \begin{enumerate}[(a)]
        ...
        \item \cpp{\%=} \hspace{20pt} 
          \ans[5in]{Adds the amount on the RHS to the variable on the LHS}
      \end{enumerate}
    ...
    \Q The table below is similar to that seen in Model 3.  Fill in the missing pieces with appropriate values or
      ...
      \begin{center}
        ...
        \begin{tabular}{|c|c|c|c|}
          ...
          \hline
          % \cpp{+=} & 6 & \ifprintanswers\cpp{x += 1;}\fi & 8 \\
          \hline
          % \cpp{+=} & 5 & \cpp{x -= x+1;} & \ifprintanswers 11\fi \\
          \hline
          % \cpp{-=} & \ifprintanswers 9\fi  & \cpp{x -= 3;} & 6 \\
          \hline
          % \cpp{*=} & 4 & \ifprintanswers\cpp{x *= 4;}\fi & 4 \\
          \hline
          % \cpp{/=} & 23 & \ifprintanswers\cpp{x /= 10;}\fi & 2 \\
          \hline
        \end{tabular}
      \end{center}
      \par\vskip -40pt\null
