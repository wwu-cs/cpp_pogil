...
int main() {
  ...
  \quest{25 min}
  \Q Explain what each line or range of lines in this program does.
    \par\vskip 10pt
    \begin{enumerate}
      \itemsep 10pt
      \item Lines 8-9: \hfill \ans[5.15in]{Prompts the user for a number and saves it in {\tt number}}
      \item Line 10:    \hfill \ans[5.15in]{Initializes the counter {\tt x} to 1}
      \item Line 11:    \hfill \ans[5.15in]{Repeats lines 12-18 as long as the counter {\tt x} is not bigger than {\tt number}}
      \item Lines 12-16: \hfill \ans[5.15in]{Prints the counter, with a new line when it is divisible by 10}
      \item Line 17:   \hfill \ans[5.15in]{Increments the counter by one before going back to line 12}
    \end{enumerate}
