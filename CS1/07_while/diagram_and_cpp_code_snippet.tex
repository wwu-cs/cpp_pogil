    ...
    \Q Which lines of code go with the following shapes on the provided diagram?
      ...
      \begin{enumerate}[(a)]
        ...
        \item The ``Block \#1'' rectangle \hfill 
          \ans[4in]{Lines 12 and 13 make up the statements in block \#1}
        \item The ``Block \#2'' rectangle \hfill 
          \ans[4in]{Line 15 contains the statement in block \#2}
      \end{enumerate}
...
\newpage
    ...
    \Q Change one or more of lines 10, 11, and 13 to make the program print the name 23 times.\key\\[-2.5mm]
