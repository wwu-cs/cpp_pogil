...
int main() {
  ...
  \Q Add the Boolean expression you chose above to the program in {\tt activity06b.cpp}. Create
    ...
    \begin{center}
      ...
      \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline
          1 & \ans[0.5in]{196} & \ans[0.5in]{3.6} & \ans[0.5in]{3.2} & \ans[1in]{graduate} & \ans[0.5in]{\checkmark} \\
        \hline
          2 & \ans[0.5in]{196} & \ans[0.5in]{3.6} & \ans[0.5in]{1.8} & \ans[1in]{don't} & \ans[0.5in]{\checkmark} \\
        \hline
          3 & \ans[0.5in]{196} & \ans[0.5in]{1.9} & \ans[0.5in]{3.2} & \ans[1in]{don't} & \ans[0.5in]{\checkmark} \\
        \hline
          4 & \ans[0.5in]{196} & \ans[0.5in]{1.7} & \ans[0.5in]{1.9} & \ans[1in] {don't} & \ans[0.5in]{\checkmark} \\
        \hline
          5 & \ans[0.5in]{188} & \ans[0.5in]{3.6} & \ans[0.5in]{3.2} & \ans[1in] {don't} & \ans[0.5in]{\checkmark} \\
        \hline
          6 & \ans[0.5in]{184} & \ans[0.5in]{3.2} & \ans[0.5in]{1.8} & \ans[1in] {don't} & \ans[0.5in]{\checkmark} \\
        \hline
          7 & \ans[0.5in]{90} & \ans[0.5in]{1.9} & \ans[0.5in]{3.2} & \ans[1in] {don't} & \ans[0.5in]{\checkmark} \\
        \hline
          8 & \ans[0.5in]{53} & \ans[0.5in]{1.6} & \ans[0.5in]{1.9} & \ans[1in] {don't} & \ans[0.5in]{\checkmark} \\
        \hline
      \end{tabular}
    \end{center}
