...
int main() {
  ...
  \Q What happens if you remove the open curly brace (\cpp{\{}) from the
      end of line 12 and \key\\[-2.5mm] the close curly brace (\cpp{\}}) from line 14 (15 in
