...
int main() {
  ...
  {\it\large Refer to Model 1 above as your group develops consensus answers
    ...
    \Q The file {\tt activity01a.cpp} contains this C++ program. Run it and determine what it does.
      \begin{answer}[1in]
        It prints out the text {\it Go!}
      \end{answer}
      
    \Q Replace line 5 with each of the following.  What is produced? Indicate if there is a problem.\par\vskip 20pt
