...
Draw the circles and edges (links) below.
...
% \newpage
\Q What is the maximum number of edges an undirected graph with 5 vertices can have? \ans{}
...
\ans[.25in]{X} matrix \ans[.25in]{} list
...
Assume the list of adjacent nodes is not in order. O(\ans[.25in]{X})
\par\vskip 10pt
