\model{Open Address Linear Probing}
  ...
  \Q Delete the key ``eggs''.
    ...
    \begin{answer}[1in]
      The strings compared are "apple", "coconut", and "eggs".
    \end{answer}

  \Q Now, insert the key ``mango''.
    This key maps to location 5.
    Update the table above.
    What location does ``mango'' go into?
    What strings are compared during the insert?
    \begin{answer}[1in]
      It goes into position 8.
      The strings compared are "apple", "coconut", "eggs".
    \end{answer}
...
int Find(HashTable& H, string key) {
  ...
  \Q Find ``corn''. This hashes to the location 1. How many string comparisons are done? Which strings are they ones compared?
    \begin{answer}[1in]
      One comparison is done.
      The only string compared is "corn".
    \end{answer}

  \Q Find ``mango''. This hashes to the location 5. How many string comparisons are done? Which strings are they ones compared?
    \begin{answer}[1in]
      Three comparisons are done.
      The strings compared are "apple", "coconut", and "mango".
    \end{answer}

  \vskip -10pt

  \Q Find ``eggs''. This hashes to the location 5. How many string comparisons are\key\\[-2.5mm] done? Which strings are they ones compared?
    \begin{answer}[1in]
      Four comparisons are done.
      The strings compared are "apple", "coconut", "eggs", and "D".
    \end{answer}
  ...
  \Q Does your group have questions about hash functions and/or hash tables?\key\\[-2.5mm]
    \begin{answer}[0.2in]
      Answers will vary
    \end{answer}