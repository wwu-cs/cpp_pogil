...
\Q (3 min) These situations are all examples of \textbf{stacks}.
...
\Q (2 min) List any variations or exceptions to these characteristics.
...
\newpage
\Q (3 min) Trace the following actions in a stack (steps a through e are provided as examples).
...
\begin{center}
  ...
  \begin{tabular}{ |r|l|p{.25cm}|l|l|l|l|p{.25cm}|l| }
    ...
    \hline
    f.                   & get top item    &  & \ans[1em]{A}                            & \ans[1em]{}  & \ans[1em]{}      & \ans[1em]{}  &  & \ans[2.5in]{}                                               \\
    \hline
