\model{Electric Circuit}
  ...
  \Q In the diagram shown above, the switch connecting the battery to the resistor is open and so electricity cannot flow.
    How does that compare with how you would describe a valve in a hydraulic system? That is, is the faucet open or closed when the water is moving?
    \begin{answer}[1in]
