  ...
  \Q How many unique combinations of dots can exist in one Braille cell?
    \begin{answer}[0.75in]
      $2^6 = 64$
    \end{answer}
  ...
  \Q Imagine an alphabet with two letters, O and X. How many words could exist in\key\\[-2.5mm] this encoding if the word size were the following values (the first two have been done for you)? What is the formula for this calculation?
